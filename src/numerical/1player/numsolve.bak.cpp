...
//cout << fabs(dfaimm1dttplus1 - f1aimm) << endl; 
//cout << fabs(dfaimm2dttplus1 - f2aimm) << endl;
//cout << fabs(dfmimm1dttplus1 - f1mimm) << endl;
//cout << fabs(dfmimm2dttplus1 - f2mimm) << endl;
//cout << fabs(dfaphil1dttplus1 - f1aphil) << endl; 
//cout << fabs(dfaphil2dttplus1 - f2aphil) << endl; 
//cout << fabs(dfmphil1dttplus1 - f1mphil) << endl; 
//cout << fabs(dfmphil2dttplus1 - f2mphil) << endl; 
